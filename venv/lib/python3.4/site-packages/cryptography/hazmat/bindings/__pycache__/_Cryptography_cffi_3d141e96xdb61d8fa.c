...
static int _cffi_e_____D_enum____D_1(PyObject *lib)
{
  if ((kCFStringEncodingASCII) <= 0 || (unsigned long)(kCFStringEncodingASCII) != 1536UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 ...
                 "enum $enum_$1: ", "kCFStringEncodingASCII", buf, "1536");
    return -1;
  }
  return ((void)lib,0);
}
...
static int _cffi_e_____D_enum____D_10(PyObject *lib)
{
  if ((kCCModeECB) <= 0 || (unsigned long)(kCCModeECB) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeECB", buf, "1");
    return -1;
  }
  if ((kCCModeCBC) <= 0 || (unsigned long)(kCCModeCBC) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeCBC", buf, "2");
    return -1;
  }
  if ((kCCModeCFB) <= 0 || (unsigned long)(kCCModeCFB) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeCFB", buf, "3");
    return -1;
  }
  if ((kCCModeCTR) <= 0 || (unsigned long)(kCCModeCTR) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeCTR", buf, "4");
    return -1;
  }
  ...
  if ((kCCModeLRW) <= 0 || (unsigned long)(kCCModeLRW) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeLRW", buf, "6");
    return -1;
  }
  if ((kCCModeOFB) <= 0 || (unsigned long)(kCCModeOFB) != 7UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeOFB", buf, "7");
    return -1;
  }
  if ((kCCModeXTS) <= 0 || (unsigned long)(kCCModeXTS) != 8UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeXTS", buf, "8");
    return -1;
  }
  if ((kCCModeRC4) <= 0 || (unsigned long)(kCCModeRC4) != 9UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeRC4", buf, "9");
    return -1;
  }
  if ((kCCModeCFB8) <= 0 || (unsigned long)(kCCModeCFB8) != 10UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeCFB8", buf, "10");
    return -1;
  }
  if ((kCCModeGCM) <= 0 || (unsigned long)(kCCModeGCM) != 11UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$10: ", "kCCModeGCM", buf, "11");
    return -1;
  }
...
{
  if ((ccNoPadding) > 0 || (long)(ccNoPadding) != 0L) {
    char buf[64];
    if ((ccNoPadding) <= 0)
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$11: ", "ccNoPadding", buf, "0");
    return -1;
  }
  if ((ccPKCS7Padding) <= 0 || (unsigned long)(ccPKCS7Padding) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$11: ", "ccPKCS7Padding", buf, "1");
    return -1;
  }
...
{
  if ((kCCWRAPAES) <= 0 || (unsigned long)(kCCWRAPAES) != 1UL) {
    char buf[64];
    if ((kCCWRAPAES) <= 0)
        snprintf(buf, 63, "%ld", (long)(kCCWRAPAES));
    else
        snprintf(buf, 63, "%lu", (unsigned long)(kCCWRAPAES));
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$12: ", "kCCWRAPAES", buf, "1");
    return -1;
  }
...
{
  if ((kSecItemTypeUnknown) > 0 || (long)(kSecItemTypeUnknown) != 0L) {
    char buf[64];
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecItemTypeUnknown", buf, "0");
    return -1;
  }
  if ((kSecItemTypePrivateKey) <= 0 || (unsigned long)(kSecItemTypePrivateKey) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecItemTypePrivateKey", buf, "1");
    return -1;
  }
  if ((kSecItemTypePublicKey) <= 0 || (unsigned long)(kSecItemTypePublicKey) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecItemTypePublicKey", buf, "2");
    return -1;
  }
  if ((kSecItemTypeSessionKey) <= 0 || (unsigned long)(kSecItemTypeSessionKey) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecItemTypeSessionKey", buf, "3");
    return -1;
  }
  if ((kSecItemTypeCertificate) <= 0 || (unsigned long)(kSecItemTypeCertificate) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecItemTypeCertificate", buf, "4");
    return -1;
  }
  if ((kSecItemTypeAggregate) <= 0 || (unsigned long)(kSecItemTypeAggregate) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$13: ", "kSecItemTypeAggregate", buf, "5");
    return -1;
  }
...
{
  if ((kSecFormatUnknown) > 0 || (long)(kSecFormatUnknown) != 0L) {
    char buf[64];
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatUnknown", buf, "0");
    return -1;
  }
  if ((kSecFormatOpenSSL) <= 0 || (unsigned long)(kSecFormatOpenSSL) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatOpenSSL", buf, "1");
    return -1;
  }
  if ((kSecFormatSSH) <= 0 || (unsigned long)(kSecFormatSSH) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatSSH", buf, "2");
    return -1;
  }
  if ((kSecFormatBSAFE) <= 0 || (unsigned long)(kSecFormatBSAFE) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatBSAFE", buf, "3");
    return -1;
  }
  if ((kSecFormatRawKey) <= 0 || (unsigned long)(kSecFormatRawKey) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatRawKey", buf, "4");
    return -1;
  }
  if ((kSecFormatWrappedPKCS8) <= 0 || (unsigned long)(kSecFormatWrappedPKCS8) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatWrappedPKCS8", buf, "5");
    return -1;
  }
  if ((kSecFormatWrappedOpenSSL) <= 0 || (unsigned long)(kSecFormatWrappedOpenSSL) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatWrappedOpenSSL", buf, "6");
    return -1;
  }
  if ((kSecFormatWrappedSSH) <= 0 || (unsigned long)(kSecFormatWrappedSSH) != 7UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatWrappedSSH", buf, "7");
    return -1;
  }
  if ((kSecFormatWrappedLSH) <= 0 || (unsigned long)(kSecFormatWrappedLSH) != 8UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatWrappedLSH", buf, "8");
    return -1;
  }
  if ((kSecFormatX509Cert) <= 0 || (unsigned long)(kSecFormatX509Cert) != 9UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatX509Cert", buf, "9");
    return -1;
  }
  if ((kSecFormatPEMSequence) <= 0 || (unsigned long)(kSecFormatPEMSequence) != 10UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatPEMSequence", buf, "10");
    return -1;
  }
  if ((kSecFormatPKCS7) <= 0 || (unsigned long)(kSecFormatPKCS7) != 11UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatPKCS7", buf, "11");
    return -1;
  }
  if ((kSecFormatPKCS12) <= 0 || (unsigned long)(kSecFormatPKCS12) != 12UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatPKCS12", buf, "12");
    return -1;
  }
  if ((kSecFormatNetscapeCertSequence) <= 0 || (unsigned long)(kSecFormatNetscapeCertSequence) != 13UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatNetscapeCertSequence", buf, "13");
    return -1;
  }
  if ((kSecFormatSSHv2) <= 0 || (unsigned long)(kSecFormatSSHv2) != 14UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$14: ", "kSecFormatSSHv2", buf, "14");
    return -1;
  }
  return _cffi_e_____D_enum____D_13(lib);
}

static int _cffi_e_____D_enum____D_15(PyObject *lib)
{
  if ((kSecKeyImportOnlyOne) <= 0 || (unsigned long)(kSecKeyImportOnlyOne) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$15: ", "kSecKeyImportOnlyOne", buf, "1");
    return -1;
  }
  if ((kSecKeySecurePassphrase) <= 0 || (unsigned long)(kSecKeySecurePassphrase) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$15: ", "kSecKeySecurePassphrase", buf, "2");
    return -1;
  }
  if ((kSecKeyNoAccessControl) <= 0 || (unsigned long)(kSecKeyNoAccessControl) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$15: ", "kSecKeyNoAccessControl", buf, "4");
    return -1;
  }
...
static int _cffi_e_____D_enum____D_2(PyObject *lib)
{
  if ((kCFNumberSInt8Type) <= 0 || (unsigned long)(kCFNumberSInt8Type) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberSInt8Type", buf, "1");
    return -1;
  }
  if ((kCFNumberSInt16Type) <= 0 || (unsigned long)(kCFNumberSInt16Type) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberSInt16Type", buf, "2");
    return -1;
  }
  if ((kCFNumberSInt32Type) <= 0 || (unsigned long)(kCFNumberSInt32Type) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberSInt32Type", buf, "3");
    return -1;
  }
  if ((kCFNumberSInt64Type) <= 0 || (unsigned long)(kCFNumberSInt64Type) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberSInt64Type", buf, "4");
    return -1;
  }
  if ((kCFNumberFloat32Type) <= 0 || (unsigned long)(kCFNumberFloat32Type) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberFloat32Type", buf, "5");
    return -1;
  }
  if ((kCFNumberFloat64Type) <= 0 || (unsigned long)(kCFNumberFloat64Type) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberFloat64Type", buf, "6");
    return -1;
  }
  if ((kCFNumberCharType) <= 0 || (unsigned long)(kCFNumberCharType) != 7UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberCharType", buf, "7");
    return -1;
  }
  if ((kCFNumberShortType) <= 0 || (unsigned long)(kCFNumberShortType) != 8UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberShortType", buf, "8");
    return -1;
  }
  if ((kCFNumberIntType) <= 0 || (unsigned long)(kCFNumberIntType) != 9UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberIntType", buf, "9");
    return -1;
  }
  if ((kCFNumberLongType) <= 0 || (unsigned long)(kCFNumberLongType) != 10UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberLongType", buf, "10");
    return -1;
  }
  if ((kCFNumberLongLongType) <= 0 || (unsigned long)(kCFNumberLongLongType) != 11UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberLongLongType", buf, "11");
    return -1;
  }
  if ((kCFNumberFloatType) <= 0 || (unsigned long)(kCFNumberFloatType) != 12UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberFloatType", buf, "12");
    return -1;
  }
  if ((kCFNumberDoubleType) <= 0 || (unsigned long)(kCFNumberDoubleType) != 13UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberDoubleType", buf, "13");
    return -1;
  }
  if ((kCFNumberCFIndexType) <= 0 || (unsigned long)(kCFNumberCFIndexType) != 14UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberCFIndexType", buf, "14");
    return -1;
  }
  if ((kCFNumberNSIntegerType) <= 0 || (unsigned long)(kCFNumberNSIntegerType) != 15UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberNSIntegerType", buf, "15");
    return -1;
  }
  if ((kCFNumberCGFloatType) <= 0 || (unsigned long)(kCFNumberCGFloatType) != 16UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberCGFloatType", buf, "16");
    return -1;
  }
  if ((kCFNumberMaxType) <= 0 || (unsigned long)(kCFNumberMaxType) != 16UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$2: ", "kCFNumberMaxType", buf, "16");
    return -1;
  }
  return _cffi_e_____D_enum____D_15(lib);
}

static int _cffi_e_____D_enum____D_3(PyObject *lib)
{
  if ((kCCHmacAlgSHA1) > 0 || (long)(kCCHmacAlgSHA1) != 0L) {
    char buf[64];
    if ((kCCHmacAlgSHA1) <= 0)
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$3: ", "kCCHmacAlgSHA1", buf, "0");
    return -1;
  }
  if ((kCCHmacAlgMD5) <= 0 || (unsigned long)(kCCHmacAlgMD5) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$3: ", "kCCHmacAlgMD5", buf, "1");
    return -1;
  }
  if ((kCCHmacAlgSHA256) <= 0 || (unsigned long)(kCCHmacAlgSHA256) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$3: ", "kCCHmacAlgSHA256", buf, "2");
    return -1;
  }
  if ((kCCHmacAlgSHA384) <= 0 || (unsigned long)(kCCHmacAlgSHA384) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$3: ", "kCCHmacAlgSHA384", buf, "3");
    return -1;
  }
  if ((kCCHmacAlgSHA512) <= 0 || (unsigned long)(kCCHmacAlgSHA512) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$3: ", "kCCHmacAlgSHA512", buf, "4");
    return -1;
  }
  if ((kCCHmacAlgSHA224) <= 0 || (unsigned long)(kCCHmacAlgSHA224) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$3: ", "kCCHmacAlgSHA224", buf, "5");
    return -1;
  }
...
static int _cffi_e_____D_enum____D_5(PyObject *lib)
{
  if ((kCCPRFHmacAlgSHA1) <= 0 || (unsigned long)(kCCPRFHmacAlgSHA1) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$5: ", "kCCPRFHmacAlgSHA1", buf, "1");
    return -1;
  }
  if ((kCCPRFHmacAlgSHA224) <= 0 || (unsigned long)(kCCPRFHmacAlgSHA224) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$5: ", "kCCPRFHmacAlgSHA224", buf, "2");
    return -1;
  }
  if ((kCCPRFHmacAlgSHA256) <= 0 || (unsigned long)(kCCPRFHmacAlgSHA256) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$5: ", "kCCPRFHmacAlgSHA256", buf, "3");
    return -1;
  }
  if ((kCCPRFHmacAlgSHA384) <= 0 || (unsigned long)(kCCPRFHmacAlgSHA384) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$5: ", "kCCPRFHmacAlgSHA384", buf, "4");
    return -1;
  }
  if ((kCCPRFHmacAlgSHA512) <= 0 || (unsigned long)(kCCPRFHmacAlgSHA512) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$5: ", "kCCPRFHmacAlgSHA512", buf, "5");
    return -1;
  }
...
{
  if ((kCCAlgorithmAES128) > 0 || (long)(kCCAlgorithmAES128) != 0L) {
    char buf[64];
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$6: ", "kCCAlgorithmAES128", buf, "0");
    return -1;
  }
  if ((kCCAlgorithmDES) <= 0 || (unsigned long)(kCCAlgorithmDES) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$6: ", "kCCAlgorithmDES", buf, "1");
    return -1;
  }
  if ((kCCAlgorithm3DES) <= 0 || (unsigned long)(kCCAlgorithm3DES) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$6: ", "kCCAlgorithm3DES", buf, "2");
    return -1;
  }
  if ((kCCAlgorithmCAST) <= 0 || (unsigned long)(kCCAlgorithmCAST) != 3UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$6: ", "kCCAlgorithmCAST", buf, "3");
    return -1;
  }
  if ((kCCAlgorithmRC4) <= 0 || (unsigned long)(kCCAlgorithmRC4) != 4UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$6: ", "kCCAlgorithmRC4", buf, "4");
    return -1;
  }
  if ((kCCAlgorithmRC2) <= 0 || (unsigned long)(kCCAlgorithmRC2) != 5UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$6: ", "kCCAlgorithmRC2", buf, "5");
    return -1;
  }
  if ((kCCAlgorithmBlowfish) <= 0 || (unsigned long)(kCCAlgorithmBlowfish) != 6UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$6: ", "kCCAlgorithmBlowfish", buf, "6");
    return -1;
  }
...
{
  if ((kCCSuccess) > 0 || (long)(kCCSuccess) != 0L) {
    char buf[64];
    if ((kCCSuccess) <= 0)
  ...
  if ((kCCParamError) > 0 || (long)(kCCParamError) != -4300L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$7: ", "kCCParamError", buf, "-4300");
    return -1;
  }
  if ((kCCBufferTooSmall) > 0 || (long)(kCCBufferTooSmall) != -4301L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$7: ", "kCCBufferTooSmall", buf, "-4301");
    return -1;
  }
  if ((kCCMemoryFailure) > 0 || (long)(kCCMemoryFailure) != -4302L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$7: ", "kCCMemoryFailure", buf, "-4302");
    return -1;
  }
  if ((kCCAlignmentError) > 0 || (long)(kCCAlignmentError) != -4303L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$7: ", "kCCAlignmentError", buf, "-4303");
    return -1;
  }
  if ((kCCDecodeError) > 0 || (long)(kCCDecodeError) != -4304L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$7: ", "kCCDecodeError", buf, "-4304");
    return -1;
  }
  if ((kCCUnimplemented) > 0 || (long)(kCCUnimplemented) != -4305L) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$7: ", "kCCUnimplemented", buf, "-4305");
    return -1;
  }
...
{
  if ((kCCEncrypt) > 0 || (long)(kCCEncrypt) != 0L) {
    char buf[64];
    if ((kCCEncrypt) <= 0)
...
static int _cffi_e_____D_enum____D_9(PyObject *lib)
{
  if ((kCCModeOptionCTR_LE) <= 0 || (unsigned long)(kCCModeOptionCTR_LE) != 1UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$9: ", "kCCModeOptionCTR_LE", buf, "1");
    return -1;
  }
  if ((kCCModeOptionCTR_BE) <= 0 || (unsigned long)(kCCModeOptionCTR_BE) != 2UL) {
    ...
    PyErr_Format(_cffi_VerificationError,
                 "%s%s has the real value %s, not %s",
                 "enum $enum_$9: ", "kCCModeOptionCTR_BE", buf, "2");
    return -1;
  }
...
static PyObject *
_cffi_f_CCSymmetricKeyUnwrap(PyObject *self, PyObject *args)
{
  uint32_t x0;
  uint8_t const * x1;
  size_t x2;
  ...
  if (!PyArg_ParseTuple(args, "OOOOOOOOO:CCSymmetricKeyUnwrap", &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = CCSymmetricKeyUnwrap(x0, x1, x2, x3, x4, x5, x6, x7, x8); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyObject *
_cffi_f_CCSymmetricKeyWrap(PyObject *self, PyObject *args)
{
  uint32_t x0;
  uint8_t const * x1;
  size_t x2;
  ...
  if (!PyArg_ParseTuple(args, "OOOOOOOOO:CCSymmetricKeyWrap", &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7, &arg8))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = CCSymmetricKeyWrap(x0, x1, x2, x3, x4, x5, x6, x7, x8); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyObject *
_cffi_f_CCSymmetricUnwrappedSize(PyObject *self, PyObject *args)
{
  uint32_t x0;
  size_t x1;
  size_t result;
  ...
  if (!PyArg_ParseTuple(args, "OO:CCSymmetricUnwrappedSize", &arg0, &arg1))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = CCSymmetricUnwrappedSize(x0, x1); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
static PyObject *
_cffi_f_CCSymmetricWrappedSize(PyObject *self, PyObject *args)
{
  uint32_t x0;
  size_t x1;
  size_t result;
  ...
  if (!PyArg_ParseTuple(args, "OO:CCSymmetricWrappedSize", &arg0, &arg1))
    return NULL;
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = CCSymmetricWrappedSize(x0, x1); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
_cffi_f_CFRangeMake(PyObject *self, PyObject *args)
{
  ...
  (void)self; /* unused */
  return _cffi_from_c_struct((char *)&result, _cffi_type(23));
}
...
static PyObject *
_cffi_f_SecItemExport(PyObject *self, PyObject *args)
{
  CFTypeRef x0;
  uint32_t x1;
  uint32_t x2;
  SecItemImportExportKeyParameters const * x3;
  CFDataRef * x4;
  Py_ssize_t datasize;
  long result;
  PyObject *arg0;
  ...
  if (!PyArg_ParseTuple(args, "OOOOO:SecItemExport", &arg0, &arg1, &arg2, &arg3, &arg4))
    return NULL;
  ...
  if (datasize != 0) {
    ...
    x3 = alloca((size_t)datasize);
    memset((void *)x3, 0, (size_t)datasize);
    if (_cffi_convert_array_from_object((char *)x3, _cffi_type(33), arg3) < 0)
      return NULL;
  }
  ...
  Py_BEGIN_ALLOW_THREADS
  _cffi_restore_errno();
  { result = SecItemExport(x0, x1, x2, x3, x4); }
  _cffi_save_errno();
  Py_END_ALLOW_THREADS
...
_cffi_f_SecItemImport(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    ...
    x6 = alloca((size_t)datasize);
    memset((void *)x6, 0, (size_t)datasize);
    if (_cffi_convert_array_from_object((char *)x6, _cffi_type(36), arg6) < 0)
      return NULL;
  }
  ...
  if (datasize != 0) {
    ...
    x7 = alloca((size_t)datasize);
    memset((void *)x7, 0, (size_t)datasize);
    if (_cffi_convert_array_from_object((char *)x7, _cffi_type(37), arg7) < 0)
      return NULL;
  }
...
_cffi_f_SecKeychainCreate(PyObject *self, PyObject *args)
{
  ...
  if (datasize != 0) {
    ...
    x5 = alloca((size_t)datasize);
    memset((void *)x5, 0, (size_t)datasize);
    if (_cffi_convert_array_from_object((char *)x5, _cffi_type(40), arg5) < 0)
      return NULL;
  }
...
static PyMethodDef _cffi_methods[] = {
  ...
  {"CCSymmetricKeyUnwrap", _cffi_f_CCSymmetricKeyUnwrap, METH_VARARGS, NULL},
  {"CCSymmetricKeyWrap", _cffi_f_CCSymmetricKeyWrap, METH_VARARGS, NULL},
  {"CCSymmetricUnwrappedSize", _cffi_f_CCSymmetricUnwrappedSize, METH_VARARGS, NULL},
  {"CCSymmetricWrappedSize", _cffi_f_CCSymmetricWrappedSize, METH_VARARGS, NULL},
  ...
  {"SecItemExport", _cffi_f_SecItemExport, METH_VARARGS, NULL},
...
static struct PyModuleDef _cffi_module_def = {
  ...
  "_Cryptography_cffi_3d141e96xdb61d8fa",
  NULL,
  -1,
  _cffi_methods,
  NULL, NULL, NULL, NULL
...
PyMODINIT_FUNC
PyInit__Cryptography_cffi_3d141e96xdb61d8fa(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_Cryptography_cffi_3d141e96xdb61d8fa(void)
{
  PyObject *lib;
  lib = Py_InitModule("_Cryptography_cffi_3d141e96xdb61d8fa", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
